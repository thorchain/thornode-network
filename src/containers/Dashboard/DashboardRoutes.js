...
const routes = [
	{
		path: '',
		component: lazy(() => import('@iso/containers/A_UserPages/Dashboard2/Dashboard.js')),
		exact: true,
	},
	{
		path: 'admindashboard',
		component: lazy(() => import('@iso/containers/A_AdminPages/AdminDashboard/AdminDashboard.js')),
		exact: true,
	},
	{
		path: 'adminconfirm',
		component: lazy(() => import('@iso/containers/A_AdminPages/ConfirmDeposit/ConfirmDeposit.js')),
		exact: true,
	},
	{
		path: 'adminstake',
		component: lazy(() => import('@iso/containers/A_AdminPages/ConfirmStake/ConfirmStake.js')),
		exact: true,
	},
	{
		path: 'adminwithdraw',
		component: lazy(() => import('@iso/containers/A_AdminPages/ConfirmWithdraw/ConfirmWithdraw.js')),
		exact: true,
	},
	{
		path: 'stake',
		component: lazy(() => import('@iso/containers/A_UserPages/Stake/stake.js')),
		exact: true,
	},
	{
		path: 'dashboardOrig',
	...
	{
		path: 'deposit',
		component: lazy(() => import('@iso/containers/A_UserPages/Deposit/Deposits.js')),
		exact: false,
	},
	{
		path: 'withdraw',
		component: lazy(() => import('@iso/containers/A_UserPages/Withdraw/withdraw.js')),
		exact: false,
	},
	{
		path: 'faq',
		component: lazy(() => import('@iso/containers/A_UserPages/FAQ/FAQ.js')),
		exact: false,
	},
	{
		path: 'dashboard',
